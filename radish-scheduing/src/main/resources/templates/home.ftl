...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        ...
        <ul class="layui-nav my-header-user-nav" lay-filter="side-top-right">
            ...
            <li class="layui-nav-item">
                <a class="name" href="javascript:;"><img src="${base}/static/image/code.png" alt="logo"> Admin </a>
                <dl class="layui-nav-child">
        ...
        <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                                            <!-- 主要的内容面板 -->
                    <iframe id="iframe" src="${base}/portal/dashboard" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="${base}/static/js/vip_comm.js"></script>
...
layui.use(['layer','vip_nav'], function () {
    ...
    vipNav.top_left('${base}/static/json/nav_top_left.json','side-top-left',false);
    // 主体菜单生成 [请求地址,过滤ID,是否展开,携带参数]
    vipNav.main('${base}/static/json/nav_main.json','side-main',true);
